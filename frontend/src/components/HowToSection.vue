<template>
  <section id="how-to-use" class="py-16 sm:py-20 bg-bg-main" aria-labelledby="howto-heading">
    <div class="max-w-5xl mx-auto px-4 sm:px-6">
      <div class="text-center mb-12">
        <h2 id="howto-heading" class="text-2xl sm:text-3xl font-bold text-text-primary mb-3">
          如何使用 <span class="text-primary">{{ APP_NAME }}</span> 下载视频
        </h2>
...
const steps = [
  ...
  },
  {
    number: 2,
    title: '粘贴链接并解析',
    desc: `打开 ${APP_NAME}，将复制的链接粘贴到输入框中，点击"解析视频"。系统自动识别平台并解析出视频信息和所有可用清晰度。`,
  },
  {
    number: 3,
    title: '选择清晰度并下载',
